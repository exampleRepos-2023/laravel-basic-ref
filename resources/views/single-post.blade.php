<x-layout>
  <div class="container py-md-5 container--narrow">
    ...
    <p class="text-muted small mb-4">
      ...
      Posted by <a href="#">{{ $post->user->username }}</a> on {{ $post->created_at->format('jS M Y') }}
    </p>

    <div class="body-content">
      <p class="lead">{{ $post->body }}</p>
      <p>My roommate yells at me when I destroy things, but I do what I want.</p>
      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Numquam praesentium laboriosam unde fuga accusamus
        reiciendis laudantium quis consequatur, beatae temporibus nemo, tempora voluptatum, perspiciatis accusantium
